 ...
 * in a {@link CronScheduler} instance with the
 * {@link CronScheduler#addTaskCollector(TaskCollector)} method. Any registered task
...
public interface TaskCollector {
	...
	/**
	 * Once the instance has been registered on a {@link CronScheduler} instance,
	 * with the {@link CronScheduler#addTaskCollector(TaskCollector)} method, this

 ...
 * Updated by MrZalTy
 */
public class v1_11_R1 implements ScoreboardInterfaces {
	 ...
	 */
	public void init(Player player, String objectiveName) {
		this.player = player;
	...
	/**
	 * Send the packets to remove this scoreboard sign. A destroyed scoreboard sign must be recreated using {@link v1_11_R1#create()} in order
	 * to be used again
	 */
	public void destroy() {
		if (!created)

 ...
 * @author zyuiop
 */
public class v1_8_R3 implements ScoreboardInterfaces {
	...
	/**
	 * Send the packets to remove this scoreboard sign. A destroyed scoreboard sign must be recreated using {@link v1_8_R3#create()} in order
	 * to be used again
	 */
	public void destroy() {
		if (!created)

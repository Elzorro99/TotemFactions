 ...
 * Updated by MrZalTy
 */
public class v1_10_R1 implements ScoreboardInterfaces {
	...
	/**
	 * Send the packets to remove this scoreboard sign. A destroyed scoreboard sign must be recreated using {@link v1_10_R1#create()} in order
	 * to be used again
	 */
	public void destroy() {
		if (!created)
